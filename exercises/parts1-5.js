...
// console.log(`It would take ${spaceShuttle.name} ${spaceShuttle.getDaysToLocation(kilometersToMars)} days to reach Mars`);
// console.log(`${spaceShuttle.getDaysToLocation(kilometersToTheMoon)} days would take ${spaceShuttle.name} to the Moon`);
